...
CC_MQTT311_LIBS_DEPENDENCIES = \
    ...
    $(if $(BR2_PACKAGE_CC_MQTT311_LIBS_CLIENT_APPS_WITH_TLS),openssl,)
...
CC_MQTT311_LIBS_CONF_OPTS = \
    ...
    -DCC_MQTT311_CLIENT_APPS_WITH_OPENSSL=$(if $(BR2_PACKAGE_CC_MQTT311_LIBS_CLIENT_APPS_WITH_TLS),ON,OFF)
